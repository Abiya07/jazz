...
<body>
<form:form name="regForm" id="regForm" modelAttribute="user" action="registerProcess" method="post" onsubmit="return validate()">
 <table align="center">
                    ...
                    <tr>
                        ...
                        <td>
                            <form:password path="password" name="password" id="password" maxlength="7"/>
                    ...
                    <tr>
                        ...
                        <td>
                            <form:input path="email" name="email" id="email" /><span style="color:red">${exists}</span>
